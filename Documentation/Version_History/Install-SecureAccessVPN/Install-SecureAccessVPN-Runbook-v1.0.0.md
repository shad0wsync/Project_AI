...
✓ **Forces system reboot** in 10 seconds upon successful installation (exit code 0 or 3010)  
...
4. **Initiates forced system reboot in 10 seconds**
...
✓ **System initiates reboot in 10 seconds (no user intervention)**
```

**Duration:** 10 seconds (grace period) then automatic reboot
...
# System reboots automatically in 10 seconds
```
